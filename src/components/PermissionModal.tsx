  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-4">
      ...
      >
        ...
        <h2 className="text-2xl font-serif font-medium text-white mb-3">Permissions Blocked</h2>
        <p className="text-white/60 text-sm mb-6 leading-relaxed">
          Your browser has blocked microphone or camera access for this site. RIYA needs these to hear and see you!
        </p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-left w-full mb-8">
          ...
          <ol className="text-xs text-white/60 list-decimal pl-4 space-y-2">
            ...
            <li>Find <strong>Microphone</strong> and <strong>Camera</strong> and change them to <strong>Allow</strong>.</li>
